package com.eghuihe.module_schedule.ui.teacher.fragment.schedule;
 ...
 * @desc 老师端待上课课程
 */
public class ScheduleTeacherWaitingClassFragment extends BaseMvpRVRefreshFragment<ScheduleMechanismWaitingClassRvAdapter, MechanismSchedulePresenter>
    ...
    public void doRefresh() {
        ...
        getPresenter().queryMechanismOfflineSchedule(
                LoginHelper.getLoginInfo().getUserInfoEntity().getAdmin_id(),
                "mechanism_offline",
                "1",
                "teach_paypal_course",
                getCurrentPage(),
