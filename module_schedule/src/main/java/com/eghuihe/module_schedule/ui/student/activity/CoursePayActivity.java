...
@Route(path = ARouterConfig.SCHEDULE_COURSEPAYACTIVITY)
public class CoursePayActivity extends BaseMvpActivity<CoursePayPresenter>
    ...
    private void aliPay() {
        if (payDetailEntity != null) {
            String number_of_lessons = studentScheduleEntity.getNumber_of_lessons();
            getPresenter().studentScheduleAlipay(
                    ...
                    false,
                    studentScheduleEntity.getAppointment_id(),
                    studentScheduleEntity.getStudy_card_id(),
                    mUserCouponEntity != null ? mUserCouponEntity.getId() : null,
                    isPointsChecked ? String.valueOf(payDetailEntity.getPoints()) : null,
                    "ali",
                    studentScheduleEntity.getMechanism_id(),
    ...
    protected void initData() {
        ...
        if (intent != null) {
            String studentScheduleJson = intent.getStringExtra(ArgumentsConfig.KEY_STUDENT_SCHEDULE_ENTITY);
            studentScheduleEntity = JsonUtil.fromJson(studentScheduleJson, StudentScheduleModel.StudentScheduleEntity.class);
            String number_of_lessons = studentScheduleEntity.getNumber_of_lessons();
