...
import com.eghuihe.module_user.me.mvp.InsertMechanismTeacherContract;
import com.eghuihe.module_user.me.mvp.InsertMechanismTeacherPresenter;
...
public class InsertMechanismTeacherActivity extends BaseMvpTitleActivity<InsertMechanismTeacherPresenter>
        implements InsertMechanismTeacherContract.View {
    ...
    private void commit() {
        ...
        getPresenter().insertMechanismMaster(
    ...
    @Override
    protected InsertMechanismTeacherPresenter createPresenter() {
        return new InsertMechanismTeacherPresenter();
    }
