...
import com.eghuihe.module_user.me.mvp.TeachPayMechanismLiveCourseDetailContract;
import com.eghuihe.module_user.me.mvp.TeachPayMechanismLiveCourseDetailPresenter;
 ...
 * @desc 教付保 机构课程详情
 */
@Route(path = ARouterConfig.ME_MECHANISM_COURSE_DETAIL2)
public class TeachPayMechanismCourseDetail2Activity extends BaseMvpActivity<TeachPayMechanismLiveCourseDetailPresenter>
        implements TeachPayMechanismLiveCourseDetailContract.View {
    ...
    private void questDiscountBuy() {
        ...
        ActivityToActivity.toActivity(
                ARouterConfig.SCHEDULE_LIVECOURSEPAYACTIVITY,
                params);
    }
    ...
    protected void initData() {
        ...
        getPresenter().queryMechanismMasterSetPriceDisplay(
                exclusiveCoursesEntity.getId(),
                exclusiveCoursesEntity.getLive_streaming_id());
    }
    ...
    private void initHeadView(View headView) {
        ...
        ivCourseCover.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!TextUtils.isEmpty(cover)) {
                    Intent intent = new Intent(TeachPayMechanismCourseDetail2Activity.this, PhotoViewActivity.class);
       ...
       boolean isLiving = !TextUtils.isEmpty(live_streaming_id) && !"0".equals(live_streaming_id);
        ...
        ivLiviing.setVisibility(View.GONE);
    ...
    @Override
    protected TeachPayMechanismLiveCourseDetailPresenter createPresenter() {
        return new TeachPayMechanismLiveCourseDetailPresenter();
    }
