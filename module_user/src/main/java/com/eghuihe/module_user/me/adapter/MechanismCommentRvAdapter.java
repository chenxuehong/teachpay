...
public class MechanismCommentRvAdapter extends EmptyRVAdapter<MechanismCommentEntity> {
    public MechanismCommentRvAdapter(int layoutId, Context context, int emptyDataLayoutId) {
    ...
    protected void convert(ViewHolder viewHolder, MechanismCommentEntity mechanismCommentEntity, int position) {
        ...
        if (map != null) {
            ...
            if (userinfo != null) {
                ...
                viewHolder.setText(R.id.item_mechanism_comment_tv_nickName, nick_name);
                CircleImageView ivHead = viewHolder.getView(R.id.item_mechanism_comment_iv_head);
        ...
        viewHolder.setText(R.id.item_mechanism_comment_tv_score, score.concat("分"));
        viewHolder.setText(R.id.item_mechanism_comment_tv_time, create_time);
        viewHolder.setVisible(R.id.item_mechanism_comment_tv_content,!TextUtils.isEmpty(content));
        viewHolder.setText(R.id.item_mechanism_comment_tv_content, content);
        ...
        if (!TextUtils.isEmpty(photo_url)) {
            ...
            RecyclerViewFixed rvPics = viewHolder.getView(R.id.item_mechanism_comment_rv_pics);
