...
public class UseCouponCourseListRvAdapter  extends EmptyRVAdapter<MasterSetPriceEntity> {

    public UseCouponCourseListRvAdapter(int layoutId, Context context) {
    ...
    protected void convert(ViewHolder viewHolder, final MasterSetPriceEntity masterSetPriceEntity, int position) {
        ...
        viewHolder.setText(R.id.item_query_mechanism_course_tv_payNum,
                String.format(context.getResources().getString(com.huihe.base_lib.R.string.purchased_num), pay_num));
        ...
        if (container(masterSetPriceEntity, "single_payment")) {
            ...
            if (isLiving){
                tvName.insertDrawable(R.mipmap.living);
            }
