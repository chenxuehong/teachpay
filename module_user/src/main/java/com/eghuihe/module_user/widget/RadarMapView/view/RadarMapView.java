...
public class RadarMapView extends View {
    ...
    private void initAttrs(AttributeSet attrs){
        ...
        division = typedArray.getInteger(R.styleable.RadarMapView_rmv_division,4);
        textSize = typedArray.getDimension(R.styleable.RadarMapView_rmv_textSize,20.0f);
        textColor = typedArray.getColor(R.styleable.RadarMapView_rmv_textColor,Color.GRAY);
        lineColor = typedArray.getColor(R.styleable.RadarMapView_rmv_lineColor,Color.GRAY);
        fillColor  = typedArray.getColor(R.styleable.RadarMapView_rmv_fillColor, 0xcc3F51B5);
        strokeWidth   = typedArray.getFloat(R.styleable.RadarMapView_rmv_strokeWidth,1.0f);
