package com.jay.daguerre.widget;
...
import com.jay.daguerre.internal.CropWindowEdgeSelector;
import com.jay.daguerre.internal.Edge;
import com.jay.daguerre.utils.CatchEdgeUtil;
...
public class ClipImageView extends AppCompatImageView {
    ...
    private void init(@NonNull Context context) {
        ...
        mBorderPaint.setStrokeWidth(DensityUtils.dp2px(context, 3));
        mBorderPaint.setColor(Color.parseColor("#f50d86"));

        mGuidelinePaint = new Paint();
        mGuidelinePaint.setStyle(Paint.Style.STROKE);
        mGuidelinePaint.setStrokeWidth(DensityUtils.dp2px(context, 1));
        mGuidelinePaint.setColor(Color.parseColor("#f50d86"));


        mCornerPaint = new Paint();
        mCornerPaint.setStyle(Paint.Style.STROKE);
        mCornerPaint.setStrokeWidth(DensityUtils.dp2px(context, 5));
        mCornerPaint.setColor(Color.parseColor("#f50d86"));


        mScaleRadius = DensityUtils.dp2px(context, 24);
        mBorderThickness = DensityUtils.dp2px(context, 3);
        mCornerThickness = DensityUtils.dp2px(context, 5);
        mCornerLength = DensityUtils.dp2px(context, 20);
    }
    ...
    public Rect getImageRect() {
        ...
        return new Rect((int) (cropX), (int) (cropY), (int) (cropX + cropWidth), (int) (cropY + cropHeight));
    ...
    public Bitmap getCroppedImage() {
        ...
        final float cropX = bitmapLeft / scaleX;
        final float cropY = bitmapTop / scaleY;
