...
public class MechanismAppointmentModel extends JsonListResult<MechanismAppointmentModel.MechanismAppointmentEntity> {
    public static class MechanismAppointmentEntity {
