...
public class UserLikeSingleModel extends JsonResult<UserLikeModel.UserLikeEntity> {
    public class UserLikeEntity{
        ...
        private UserLikeModel.UserLikeEntity.MapBean map;
        ...
        public UserLikeModel.UserLikeEntity.MapBean getMap() {
            return map;
        }

        public void setMap(UserLikeModel.UserLikeEntity.MapBean map) {
            this.map = map;
        }
        ...
        public  class MapBean {
            ...
            private UserLikeModel.UserLikeEntity.MapBean.UserinfoBean userinfo;

            public UserLikeModel.UserLikeEntity.MapBean.UserinfoBean getUserinfo() {
                return userinfo;
            }

            public void setUserinfo(UserLikeModel.UserLikeEntity.MapBean.UserinfoBean userinfo) {
