...
public class ZXingUtils {
     ...
     * @throws WriterException
     */
    public static Bitmap createQRCode(String url, Bitmap logo, int width, int height) {

        Bitmap qrImage = createQRImage(url, width, height);
        Bitmap bitmap = addLogo(qrImage, logo);
        return bitmap;
    }
     ...
     * @return
     */
    private static Bitmap addLogo(Bitmap bm_QR, Bitmap bm_logo) {
        if (bm_QR == null) {
            return null;
        }
        if (bm_logo == null) {
