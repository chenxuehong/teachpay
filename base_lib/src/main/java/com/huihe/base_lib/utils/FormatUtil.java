...
public class FormatUtil {
     ...
     * @return
     */
    public static boolean checkCheseName(String name) {
        boolean res = true;
     ...
     * @return
     */
    public static boolean checkHasChese(String name) {
    ...
    public static String getCardNo(String str, int starNum) {
        if (TextUtils.isEmpty(str)) {
            return "";
        }
        char[] chars = str.toCharArray();
        int length = chars.length;
        int startLength = length / 2 - starNum;
        int endLength = length - startLength - starNum;
        return str.replaceAll("(\\d{" + startLength + "})\\d{" + starNum + "}(\\d{" + endLength + "})", "$1****$2");
    }
