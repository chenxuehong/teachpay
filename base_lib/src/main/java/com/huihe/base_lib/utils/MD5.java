...
public class MD5
{
	...
	public byte[] getMD5Digest(String s)
	{
		md5Init();
		md5Update(s.getBytes(), s.length());
		md5Final();
	...
	{
		MD5 md5 = new MD5();
		return md5.getMD5Digest(s);
	}
	
	public static String getMessageDigest(byte[] bytes)
	{
		MD5 md5 = new MD5();
		return md5.getMD5Digest(bytes);
	}
	
	public String getMD5Digest(byte[] bytes)
	{
		md5Init();
	...
	/*public static void main(String[] args)
	{
		...
		System.out.println(MD5.toMD5("The quick brown fox jumps over the lazy dog"));//9e107d9d372bb6826bd81d3542a419d6
		System.out.println(MD5.toMD5("The quick brown fox jumps over the lazy cog"));//1055D3E698D289F2AF8663725127BD4B
		System.out.println(MD5.toMD5(""));//D41D8CD98F00B204E9800998ECF8427E
		System.out.println(MD5.toMD5("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdef"));//bc4ef011bf8fd545fc598cd2e4e4e90d
		System.out.println(MD5.toMD5("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"));
	}*/
}