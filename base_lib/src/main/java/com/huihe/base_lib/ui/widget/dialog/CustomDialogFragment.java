...
public class CustomDialogFragment extends AppCompatDialogFragment {
    private static CustomDialogFragment mDialog;

    public static CustomDialogFragment getmDialog() {
        return mDialog;
    }
    ...
    public void onDestroyView() {
        // 设置布局
        if (params.onDestoryListener != null) {
            params.onDestoryListener.OnDestory(this, viewHolder);
        }
        super.onDestroyView();
    }
    ...
    private void setDialog() {
        ...
        // 设置宽高和位置
        if (params.perWidth>0){
            window.setLayout((int) (getScreenWidth(getContext()) * params.perWidth + 0.5f),
                   WindowManager.LayoutParams.WRAP_CONTENT);
        }else {
            window.setLayout(params.width,
                    params.height);
        }
    ...
    public static class Builder {
         ...
         * @param perWidth
         */
        public Builder setPerWidth(double perWidth) {
            P.perWidth = perWidth;
            return this;
        }
        ...
        public Builder setOnDestoryListener(OnDestoryListener listener) {
            P.onDestoryListener = listener;
            return this;
        }
         ...
         *
         * @return 创建好的对话框
         * @throws NullPointerException 如果布局文件 ID 小于等于 0
         */
    ...
    public void show(FragmentManager manager, String tag) {
        ...
        ft.add(CustomDialogFragment.this, tag);
    ...
    public static class DialogParams implements Parcelable {
        ...
        private OnDestoryListener onDestoryListener;
        ...
        DialogParams(Parcel in) {
            ...
            perWidth = in.readDouble();
            cancelable = in.readByte() != 0;
        }

        public final Parcelable.Creator<DialogParams> CREATOR = new Creator<DialogParams>() {
            @Override
    ...
    public interface OnDestoryListener {
        void OnDestory(DialogFragment dialog, ViewHolder holder);
    }
}
