...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected int topLineColor = 0xFFe6e6e6;
    ...
    protected final View makeContentView() {
        ...
        if (contentLeftAndRightPadding > 0) {
            lr = DensityUtils.dp2px(activity, contentLeftAndRightPadding);
        }
        if (contentTopAndBottomPadding > 0) {
            tb = DensityUtils.dp2px(activity, contentTopAndBottomPadding);
        }
    ...
    protected View makeHeaderView() {
        ...
        int height = DensityUtils.dp2px(activity, topHeight);
        ...
        int padding = DensityUtils.dp2px(activity, topPadding);
        ...
        if (null == titleView) {
            ...
            int margin = DensityUtils.dp2px(activity, topPadding);
