...
public class WheelView extends View {
    ...
    private boolean isLoop = false;//循环滚动
    ...
    public void setTextPadding(int textPadding) {
        this.textPadding = DensityUtils.dp2px(getContext(), textPadding);
    }
    ...
    private void remeasure() {
        ...
        if (useWeight) {
            ...
            if (textPadding < 0) {
                textPadding = DensityUtils.dp2px(getContext(), ITEM_PADDING);
            }
        ...
        LogUtils.d("WheelView","measuredWidth=" + measuredWidth + ",measuredHeight=" + measuredHeight);
    ...
    private void measuredCenterContentStart(String content) {
        ...
        switch (gravity) {
            case Gravity.CENTER://显示内容居中
                ...
                break;
            case Gravity.LEFT:
                drawCenterContentStart = DensityUtils.dp2px(getContext(), 8);
                break;
    ...
    private void measuredOutContentStart(String content) {
        ...
        switch (gravity) {
            case Gravity.CENTER:
                ...
                break;
            case Gravity.LEFT:
                drawOutContentStart =DensityUtils.dp2px(getContext(), 8);
                break;
            case Gravity.RIGHT:
