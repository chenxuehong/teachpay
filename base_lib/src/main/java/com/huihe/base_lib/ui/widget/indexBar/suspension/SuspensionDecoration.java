package com.huihe.base_lib.ui.widget.indexBar.suspension;
...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    public SuspensionDecoration(Context context, List<? extends ISuspensionInterface> datas) {
        ...
        mPaint = new Paint();
        mBounds = new Rect();
        mTitleHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 20f, context.getResources().getDisplayMetrics());
...
//                TUIKitLog.d(TAG, "onDrawOver() called with: c = [" + child.getTop());//当getTop开始变负，它的绝对值，是第一个可见的Item移出屏幕的距离，
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (position > -1) {
            ...
            //等于0肯定要有title的,
            // 2016 11 07 add_blue 考虑到headerView 等于0 也不应该有title
            // 2016 11 10 add_blue 通过接口里的isShowSuspension() 方法，先过滤掉不想显示悬停的item
