package com.huihe.base_lib.ui.widget.indexBar.widget;
...
import com.huihe.base_lib.ui.widget.indexBar.helper.IIndexBarDataHelper;
import com.huihe.base_lib.ui.widget.indexBar.helper.IndexBarDataHelperImpl;
...
public class LetterSideBar extends View {
    ...
    private List<String> mData;//Adapter的数据源
     ...
     * @return
     */
    public LetterSideBar setHeaderViewCount(int headerViewCount) {
     ...
     * @return
     */
    public LetterSideBar setSourceDatasAlreadySorted(boolean sourceDatasAlreadySorted) {
     ...
     * @return
     */
    public LetterSideBar setDataHelper(IIndexBarDataHelper dataHelper) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPressedBackground = context.getResources().getColor(R.color.color_44666666);//默认按下是纯黑色
        ...
        mPaint.setColor(context.getResources().getColor(R.color.color_333333));
                    ...
                    if (position != -1) {
                        ...
                        if (mData!=null){
                            for (int i = 0; i < mData.size(); i++) {
                                ...
                                String firstSpell = PinYinUtil.getFirstSpell(content).toUpperCase();
                                firstSpell = String.valueOf(firstSpell.charAt(0));
                                if (firstSpell.equals(text)){
                                    position= i;
                                    break;
                                }
                            }
    ...
    public LetterSideBar setPressedShowTextView(TextView mPressedShowTextView) {
        this.mPressedShowTextView = mPressedShowTextView;
        return this;
    }

    public LetterSideBar setLayoutManager(CustomLinearLayoutManager mLayoutManager) {
     ...
     * @return
     */
    public LetterSideBar setNeedRealIndex(boolean needRealIndex) {
    ...
    public LetterSideBar setSourceDatas(List<? extends BaseIndexPinyinBean> mSourceDatas) {
