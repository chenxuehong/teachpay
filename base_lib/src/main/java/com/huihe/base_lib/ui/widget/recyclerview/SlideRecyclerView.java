...
public class SlideRecyclerView extends RecyclerView {
    ...
    private static final int MAX_SNAP_VELOCITY = 1000;   // 最大滑动速度
    ...
    public boolean onInterceptTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.abs(xVelocity) > SNAP_VELOCITY && Math.abs(xVelocity) < MAX_SNAP_VELOCITY && Math.abs(xVelocity) > Math.abs(yVelocity)
