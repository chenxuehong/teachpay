package com.huihe.base_lib.ui.widget.shadow;
...
public class ShadowLayout extends FrameLayout {
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mShadowRadius = attr.getDimension(R.styleable.ShadowLayout_sl_shadowRadius, 10);
    ...
    private void setBackgroundCompat(int w, int h) {
        Log.i(TAG, "setBackgroundCompat: w=" + w + ", h=" + h);
