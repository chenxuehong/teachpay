...
public class DragFloatActionButton extends FloatingActionButton {
    ...
    private void init() {
        ...
        statusHeight = DensityUtils.getStatusHeight(getContext());
        virtualHeight = DensityUtils.getVirtualBarHeigh(getContext());
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (y > screenHeight - statusHeight - getHeight() - marginBottom) {
                    y = screenHeight - statusHeight - getHeight() - marginBottom;
                }
                setX(x);
                setY(y);
                lastX = rawX;
