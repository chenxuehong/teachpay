...
public class DateTimePicker extends WheelPicker {
    ...
    private void updateTitle() {
        if (titleView != null && titleView instanceof TextView && (dateMode == YEAR_MONTH_DAY)) {

            String dateStr = years.get(selectedYearIndex) + "-" + months.get(selectedMonthIndex) + "-" + days.get(selectedDayIndex);
            String weekStr = "";
            ...
            ((TextView) titleView).setText(years.get(selectedYearIndex) + " (" + weekStr + ")");
        }
    }
