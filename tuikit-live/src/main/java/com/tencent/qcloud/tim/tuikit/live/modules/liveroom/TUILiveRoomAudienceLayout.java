...
public class TUILiveRoomAudienceLayout extends FrameLayout {
     ...
     */
    public void initWithRoomId(FragmentManager fragmentManager, int roomId, String anchorId, boolean useCdn, String cdnURL, String liveDetailEntity) {
        ...
        bundle.putString(Constants.DATA, liveDetailEntity);
