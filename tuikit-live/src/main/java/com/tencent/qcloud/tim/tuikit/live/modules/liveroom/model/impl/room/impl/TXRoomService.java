...
//            }
            doSthAfterCreateSuccess(roomId, roomName, coverUrl, callback);
            return;
        }
        if (!isLogin()) {
    ...
    private void doSthAfterCreateSuccess(String roomId, String roomName, String coverUrl, TXCallback callback) {
        cleanStatus();
        initGroupListener();
