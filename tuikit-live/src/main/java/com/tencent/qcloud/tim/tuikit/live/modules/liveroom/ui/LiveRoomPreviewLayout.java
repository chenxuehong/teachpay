...
public class LiveRoomPreviewLayout extends ConstraintLayout {
    ...
    private CircleImageView mImgLiveRoomCover;

    public void setRoomName(String roomName){

        mEditLiveRoomName.setText(roomName);
    }

    public String getRoomName() {
        return mEditLiveRoomName.getText().toString().trim();
    }

    public void loadRoomCover(String cover){
        GlideEngine.loadImage(mImgLiveRoomCover,cover);
    }
    ...
    private void initView(Context context) {
        ...
        mImgLiveRoomCover = findViewById(R.id.img_live_room_cover);
