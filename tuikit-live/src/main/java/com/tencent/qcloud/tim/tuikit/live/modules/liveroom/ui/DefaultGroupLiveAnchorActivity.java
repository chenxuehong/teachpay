...
public class DefaultGroupLiveAnchorActivity extends AppCompatActivity implements TUILiveRoomAnchorLayout.TUILiveRoomAnchorLayoutDelegate {
    ...
    private AnchorLiveParam anchorLiveParam;
    ...
    public static void start(Context context, String data) {
        ...
        starter.putExtra(Constants.DATA, data);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        anchorLiveParam = JsonUtil.fromJson(json, AnchorLiveParam.class);
        if (anchorLiveParam != null)
            mGroupID = anchorLiveParam.room_id;
        ...
        mLayoutTuiLiverRomAnchor.initWithRoomId(getSupportFragmentManager(), json);
    }
