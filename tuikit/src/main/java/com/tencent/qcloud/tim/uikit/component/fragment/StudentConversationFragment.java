...
public class StudentConversationFragment extends BaseFragment implements ConversationManagerKit.MessageUnreadWatcher {
...
//        ConversationLayoutHelper.customizeConversation(mConversationLayout);
        ...
        mConversationLayout.showClass(false);
