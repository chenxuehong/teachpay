...
public class MessageLayout extends MessageLayoutUI {
    ...
    public void postSetAdapter(MessageListAdapter adapter) {
        ...
        mAdapter.setOnClassCustomMessageListener(new IOnClassCustomMessageListener() {
            @Override
            public void onAgreeAppointment(View view, MessageInfo messageInfo, ClassMessageHelper classMessageHelper, String id) {
                if (iOnClassCustomMessageListener != null) {
                    iOnClassCustomMessageListener.onAgreeAppointment(view, messageInfo, classMessageHelper, id);
                }
            }
            ...
            public void onRefuseAppointment(View view, MessageInfo messageInfo, ClassMessageHelper classMessageHelper, String id) {
                if (iOnClassCustomMessageListener != null) {
                    iOnClassCustomMessageListener.onRefuseAppointment(view, messageInfo, classMessageHelper, id);
                }
            }
            ...
            public void onQueryStatus(View view, MessageInfo messageInfo, ClassMessageHelper classMessageHelper) {
                if (iOnClassCustomMessageListener != null) {
                    iOnClassCustomMessageListener.onQueryStatus(view, messageInfo, classMessageHelper);
                }
            }
        });
    }
