...
import com.tencent.qcloud.tim.uikit.modules.chat.layout.message.holder.ClassTipMessageHelper;
import com.tencent.qcloud.tim.uikit.modules.chat.layout.message.holder.CommodityMessageHelper;
...
public class MessageListAdapter extends RecyclerView.Adapter {
    ...
    public void setOnClassCustomMessageListener(IOnClassCustomMessageListener iOnClassCustomMessageListener) {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (getItemViewType(position) == MessageInfo.MSG_TYPE_CUSTOM) {
            ...
            }else if (MessageInfoUtil.isClassTipMessage(msg)){
                new ClassTipMessageHelper().onDraw(customHolder,msg);
            }else if (MessageInfoUtil.isCommodityMessage(msg)){
                new CommodityMessageHelper().onDraw(customHolder,msg);
            }else if (MessageInfoUtil.isClassMessage(msg)){
                new ClassMessageHelper(iOnClassCustomMessageListener).onDraw(customHolder,msg);
