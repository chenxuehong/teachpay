...
public abstract class ChatLayoutUI extends LinearLayout implements IChatLayout {
    ...
    private void initViews() {
        ...
        vsBottom = findViewById(R.id.chat_viewStub_bottom);
        vsBottom.setLayoutResource(getBottomLayout());
        View bottomView = vsBottom.inflate();
    ...
    public void showBottomView(boolean isShow) {
        if (vsBottom!=null){
            vsBottom.setVisibility(isShow?View.VISIBLE:View.GONE);
        }
    }
